...
If we run `rake sample_data` we have just created our first user. Now we can copy and paste that code as many times as we need to create more users. Or we can use a loop.
